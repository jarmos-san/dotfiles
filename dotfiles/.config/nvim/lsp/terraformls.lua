...
--- which is not supported by terraform-ls (see relevant documentation at:
--- https://github.com/hashicorp/terraform-ls/blob/main/docs/features.md). Instead you should use `init_options` which
--- passes the settings as part of the LSP initialize call as is required by terraform-ls ( see relevant documentation
--- at https://github.com/hashicorp/terraform-ls/blob/main/docs/SETTINGS.md#how-to-pass-settings for more info).
